...
rm -Rf $CUR_DIR/release.osx/nw/node-webkit-v0.11.0-osx-x64
unzip $CUR_DIR/buildTools/nw.osx/node-webkit-v0.11.0-osx-x64.zip -d $CUR_DIR/release.osx/nw > /dev/null
echo "Creating bundle for osx..."
rm -Rf $CUR_DIR/release.osx/app.app
cp -R $CUR_DIR/release.osx/nw/node-webkit-v0.11.0-osx-x64/node-webkit.app $CUR_DIR/release.osx/app.app
...
rm -Rf $CUR_DIR/release.osx/nw/node-webkit-v0.11.0-osx-x64 $CUR_DIR/release.osx/app_icon.tiff
echo "Done!"

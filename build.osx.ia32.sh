...
rm -Rf "$CUR_DIR/release.osx/nw/node-webkit-v0.11.2-osx-ia32"
unzip "$CUR_DIR/buildTools/nw.osx/node-webkit-v0.11.2-osx-ia32.zip" -d "$CUR_DIR/release.osx/nw" > /dev/null
echo "Creating bundle for osx..."
rm -Rf "$CUR_DIR/release.osx/app.app"
cp -R "$CUR_DIR/release.osx/nw/node-webkit-v0.11.2-osx-ia32/node-webkit.app" "$CUR_DIR/release.osx/app.app"
...
rm -Rf "$CUR_DIR/release.osx/nw/node-webkit-v0.11.2-osx-ia32" "$CUR_DIR/release.osx/app_icon.tiff"
echo "Done!"
